...
if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
    ...
    function library:AddWindow(text,keybind)
        ...
        NameHub.Text = text
        NameHub.TextColor3 = Color3.fromRGB(0, 40, 255)
...
game:GetService("VirtualInputManager"):SendKeyEvent(true,305,false,game)
 game:GetService("VirtualInputManager"):SendKeyEvent(false,305,false,game)
    ...
    Main:AddToggle("Auto Set Spawn Home",true,function(value)
...
elseif _G.WhiteScreen == false then
    game:GetService("RunService"):Set3dRenderingEnabled(true)
     ...
     Main:AddToggle("Fast at",true,function(value)
...
delay(1, function()
    ...
    Dungeon:AddDropdown("Select Chips",{"Flame","Ice","Quake","Light","Dark","String","Rumble","Magma","Human: Buddha","Sand","Bird: Phoenix","Dough-Dough"},function(value)
        _G.SelectChip = value
    end)
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
    ...
    Misc:AddButton("Open Inventory Fruit",function()
     ...
     Misc:AddButton("Open Colors haki",function()
...
spawn(function()
    ...
    Misc:AddSeperator("Screen Shot Kaitan")
    
    Misc:AddButton("Screen Shot Kaitun",function()
    ...
    Misc:AddButton("Remoe ScreenKaitan",function()
    game:GetService("Players").LocalPlayer.PlayerGui.Main.Compass:Destroy()
    end)
                ...
                if _G.WalkWater then
                    if game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame.Y <= 4 then
                        if not game:GetService("Workspace"):FindFirstChild("Water") then
                            ...
                            Water.Name = "Water"
                            Water.Size = Vector3.new(15,3,15)
                            Water.Anchored = true
                            Water.Material = "Neon"
                    ...
                    elseif game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame.Y >= 4 and game:GetService("Workspace"):FindFirstChild("Water") then
    ...
    Misc:AddSeperator("Fruits Mastery Skill Settings")
    ...
    Misc:AddSeperator("Gun Mastery Skill Settings")
    
    Misc:AddToggle("Skill Z",true,function(a)
    _G.gunz = a
    end)
    
    Misc:AddToggle("Skill X",true,function(a)
    _G.gunx = a
    end)
...
elseif game.PlaceId == 4520749081 or game.PlaceId == 6381829480 or game.PlaceId == 5931540094 or game.PlaceId == 5931540094 then
    ...
    spawn(function()
        game:GetService("RunService").RenderStepped:Connect(function()
            if _G.AutoGhostShip or _G.AutoHydra or _G.AutoSantaEvents or _G.AutoSecondSea or _G.AutoXmas or _G.AutoSeaking or _G.AutoBigMomBlade or _G.AutoBigMomBoss or _G.AutoKaido or _G.AutoSaber or _G.AutoKillply or _G.AutoFarm or _G.AutoBisento or _G.AutoFarmDungeon or _G.AutoKillply or _G.AutoEnma then
    ...
    spawn(function()
        pcall(function()
            game:GetService("RunService").Stepped:Connect(function()
                if _G.AutoSantaEvents or _G.AutoHydra or _G.AutoSecondSea or _G.AutoXmas or _G.AutoSeaking or _G.AutoBigMomBlade or _G.AutoBigMomBoss or _G.AutoKaido or _G.AutoSaber or _G.AutoKillply or _G.AutoFarm or _G.AutoBisento or _G.AutoFarmDungeon or _G.AutoKillply or _G.AutoEnma or _G.NoClip then
    ...
    --
    local RenUi = library:AddWindow("ไม่มีชื่อ | KL",Enum.KeyCode.RightControl)
    --
    local Main = RenUi:AddTab("Auto Farm","6026568198")
    local Stats = RenUi:AddTab("Stats","7040410130")
    local Combat = RenUi:AddTab("Combat","7251993295")
    ...
    spawn(function()
     ...
     Main:AddSeperator("Hydra")
    
    Main:AddToggle("Auto Hydra",_G.AutoSeaking,function(value)
        _G.AutoHydra = value
        StopNoClip(_G.AutoHydra)
    end)
    ...
    spawn(function()
        while wait() do
            if _G.AutoHydra then
                pcall(function()
                    for i,v in pairs(game:GetService("Workspace").SeaMonster:GetChildren()) do
                        if game:GetService("Workspace").SeaMonster:FindFirstChild("Hydra") and v.Humanoid.Health > 0 then
                            if v.Name == "Hydra" then
                                repeat task.wait()
                                    ...
                                    VirtualUser:CaptureController()
                                    VirtualUser:ClickButton1(Vector2.new(1280, 672))
                                until v.Humanoid.Health <= 0 or not _G.AutoHydra or not game:GetService("Workspace").SeaMonster:FindFirstChild("Hydra")                       
                            end
                        else
                            if game:GetService("Workspace").Island:FindFirstChild("Legacy Island1") then
                                TP(game:GetService("Workspace").Island:FindFirstChild("Legacy Island1").ChestSpawner.CFrame * CFrame.new(0,0,2))
